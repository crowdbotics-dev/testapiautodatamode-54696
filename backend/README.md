...
## Project Structure
    ...
    ├── testapiautodatamode_54696  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_54696`
...
2. Clone this repo and `cd testapiautodatamode_54696`
